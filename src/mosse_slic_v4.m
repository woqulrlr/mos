...
%=========================================
i1=train_img(:,:,1);
[train_histograms,n]=imhist(i1);
train_histograms=train_histograms/size(i1,1)/size(i1,2);
...
for i = 287:size(img_files, 1)
    ...
    if (i == 287)
        ...
        for mos_count = 1:size(y_p,2)
            ...
            %=================================
            i2=fi(:,:,1);
            [search_histograms,n]=imhist(i2);
            search_histograms=search_histograms/size(i2,1)/size(i2,2);
            
            d(mos_count) = pdist2(train_histograms',search_histograms');
