...
for i = 1:10:size(img_files, 1)
%for i = 650:size(img_files, 1)
    ...
    if (i == 1)
        ...
        for mos_count = 1:size(y_center_pos,2)
            ...
            imwrite(fi_ora,['/home/lr/Desktop/mosse-tracker-master/src/image/v12/vvv/tmp1.jpg']);
            %sift_target = sift_code();
            imwrite(fi2,['/home/lr/Desktop/mosse-tracker-master/src/image/v12/vvv/tmp2.jpg']);
        ...
        vote_score = 0.5*standard_sift + 0.5*standard_d(:);
        score(:,8) = vote_score;
